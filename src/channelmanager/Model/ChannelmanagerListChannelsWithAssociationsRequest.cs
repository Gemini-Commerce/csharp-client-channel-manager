...
namespace channelmanager.Model
{
    ...
    /// </summary>
    [DataContract(Name = "channelmanagerListChannelsWithAssociationsRequest")]
    public partial class ChannelmanagerListChannelsWithAssociationsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelmanagerListChannelsWithAssociationsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChannelmanagerListChannelsWithAssociationsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelmanagerListChannelsWithAssociationsRequest" /> class.
        /// </summary>
        ...
        public ChannelmanagerListChannelsWithAssociationsRequest(string tenantId = default(string), long pageSize = default(long), string pageToken = default(string))
        {
            // to ensure "tenantId" is required (not null)
            if (tenantId == null)
            {
                throw new ArgumentNullException("tenantId is a required property for ChannelmanagerListChannelsWithAssociationsRequest and cannot be null");
            }
