...
namespace channelmanager.Model
{
    ...
    /// </summary>
    [DataContract(Name = "channelmanagerChannelResponse")]
    public partial class ChannelmanagerChannelResponse : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelmanagerChannelResponse" /> class.
        /// </summary>
        ...
        public ChannelmanagerChannelResponse(string id = default(string), string grn = default(string), string code = default(string), string image = default(string), string name = default(string), ChannelmanagerLanguageCode? defaultLanguage = default(ChannelmanagerLanguageCode?), ChannelmanagerChannelSettings settings = default(ChannelmanagerChannelSettings), ChannelmanagerChannelTypeWebsite website = default(ChannelmanagerChannelTypeWebsite), ChannelmanagerChannelStatus? status = default(ChannelmanagerChannelStatus?), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            this.Id = id;
            this.Grn = grn;
            this.Code = code;
