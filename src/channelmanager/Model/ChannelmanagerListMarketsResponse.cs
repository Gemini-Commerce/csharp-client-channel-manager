...
namespace channelmanager.Model
{
    ...
    /// </summary>
    [DataContract(Name = "channelmanagerListMarketsResponse")]
    public partial class ChannelmanagerListMarketsResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelmanagerListMarketsResponse" /> class.
        /// </summary>
        /// <param name="markets">markets.</param>
        /// <param name="nextPageToken">nextPageToken.</param>
        public ChannelmanagerListMarketsResponse(List<ChannelmanagerMarketResponse> markets = default(List<ChannelmanagerMarketResponse>), string nextPageToken = default(string))
        {
        ...
        public List<ChannelmanagerMarketResponse> Markets { get; set; }
