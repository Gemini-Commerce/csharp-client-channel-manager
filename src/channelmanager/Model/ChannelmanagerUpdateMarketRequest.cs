...
namespace channelmanager.Model
{
    ...
    public partial class ChannelmanagerUpdateMarketRequest : IValidatableObject
    {
        ...
        public ChannelmanagerUpdateMarketRequest(string tenantId = default(string), string id = default(string), ChannelmanagerUpdateMarketRequestPayload payload = default(ChannelmanagerUpdateMarketRequestPayload), List<string> payloadMask = default(List<string>))
        {
